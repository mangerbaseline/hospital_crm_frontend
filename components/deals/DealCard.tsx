...
import { Building2, Calendar, User, Target, DollarSign } from "lucide-react";
...
export function DealCard({ deal }: DealCardProps) {
  ...
  return (
    <Card className="overflow-hidden border-none shadow-sm hover:drop-shadow-lg transition-all p-0 rounded-xl hover:bg-muted group">
      <CardHeader className="p-5 pb-3">
        <div className="flex items-start gap-3">
          ...
          <div className="flex flex-col flex-1">
            <h3
              className="font-bold text-lg leading-tight line-clamp-1 w-full"
